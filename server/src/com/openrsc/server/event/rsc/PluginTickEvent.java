	...
	public void run() {
		...
		synchronized(getPluginTask()) {
			...
			getPluginTask().doRun();
               ...
               // Wait for the plugin to get to a pause point or finish completely. This also waits for the PluginTask to start
               // which is also intended to run plugin code on tick bounds.
               synchronized(getPluginTask()) {
